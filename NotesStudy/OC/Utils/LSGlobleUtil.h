...
#pragma mark - 导航栏字体颜色
#define TabBarItem_NoSelectColor COLOR(0.67*255.00,0.72*255.00,0.67*255.00,1.0)

#define TabBarItem_SelectColor COLOR(0.84*255.00,0.11*255.00,0.02*255.00,1.0)
...
#define MAIN_COLOR [UIColor colorWithRed:229.00/255.00 green:236.00/255.00 blue:205.00/255.00 alpha:1.0]
