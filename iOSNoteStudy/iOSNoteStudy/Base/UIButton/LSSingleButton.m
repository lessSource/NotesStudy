...
- (LSSingleButton *(^)(UIColor *normalColor, UIColor *highlightColor))highlightedColor {
    return ^id(UIColor *normalColor, UIColor *highlightColor) {
        [self setBackgroundImage:[UIImage convertColorToImage:normalColor] forState:UIControlStateNormal];
        [self setBackgroundImage:[UIImage convertColorToImage:highlightColor] forState:UIControlStateHighlighted];
        return self;
    };
}
