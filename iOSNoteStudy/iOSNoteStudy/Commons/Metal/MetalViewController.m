...
- (void)viewDidLoad {
    ...
    _view = [[MTKView alloc]initWithFrame:CGRectMake(0, 0, UIScreen.mainScreen.bounds.size.width, UIScreen.mainScreen.bounds.size.height) device:MTLCreateSystemDefaultDevice()];
    ...
    _render = [[Renderer alloc]initWithMatalKitView:_view];
